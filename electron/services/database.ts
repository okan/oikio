...
export class DatabaseService {
  ...
  deletePerson(id: number): void {
    // Also delete related meetings and action items
  ...
  // Helper to get action stats for a meeting
  ...
  deleteMeeting(id: number): void {
    // Also delete related action items
  ...
  importData(jsonData: string): void {
    ...
    // Reset data but keep default templates
